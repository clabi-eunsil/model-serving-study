...
- [ ] NIM의 목적과 vLLM 직접 운영 방식 차이 이해
- [ ] NGC catalog, NGC registry, NGC API key, NIM cache 개념 이해
- [ ] NIM image/model 선택 전 license, 지원 GPU, 사용 조건 확인
- [ ] NIM OpenAI-compatible API 구조 이해
- [ ] 실습: NGC login과 NIM image pull 준비
- [ ] 실습: NIM container 실행
- [ ] 실습: `/v1/models`, `/v1/chat/completions` 호출
- [ ] 실습: OpenAI SDK로 NIM endpoint 호출
- [ ] 실습: vLLM과 같은 prompt로 latency 비교
- [ ] 실습 마무리: NIM container 종료, `.venv` deactivate, 결과 기록
